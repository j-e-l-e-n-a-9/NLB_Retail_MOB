Feature: Current_Foreign_Accounts
  ...
  Scenario Outline: Current_Foreign_Accounts-Product_Details-Financial-Details_Is_Not_Visible_[MOB_ANDROID]
    ...
    And Scroll until element with IBAN from Excel "<rowindex>" columnName "second_personal_account_iban" is in the view
    When Click on element by text from excel "<rowindex>" columnName "second_personal_account_iban"
...
#     And Assert that text "Account number" has first following sibling that contains from Excel "<rowindex>" columnName "second_personal_account_iban"
#     And Assert that text "IBAN" has first following sibling that contains from Excel "<rowindex>" columnName "second_personal_account_iban"
