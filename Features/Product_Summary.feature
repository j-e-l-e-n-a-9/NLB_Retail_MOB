Feature: Product_Summary
  ...
  @Product_Summary_Favorite_account_[MOB_ANDROID]-Removal_Of_The_Favorite_Account
  Scenario Outline: Product_Summary_Favorite_account_[MOB_ANDROID]-Removal_Of_The_Favorite_Account
