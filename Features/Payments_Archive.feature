...
#    And Assert list of element by id "nlb-details" is displayed
  ...
  @Payments_Payments_Arhive_Resubmit_Payments_From_Past_Payment_List_[ANDROID]-Internal_Transfer
  Scenario Outline: Payments_Payments_Arhive_Resubmit_Payments_From_Past_Payment_List_[ANDROID]-Internal_Transfer
...
#    And Assert element by text from excel "<rowindex>" columnName "currentDomesticAccountBBAN"
  ...
  @Payments_Payments_Arhive_Resubmit_Payments_From_Past_Payment_List_[ANDROID]-Domestic_Payment
  Scenario Outline: Payments_Payments_Arhive_Resubmit_Payments_From_Past_Payment_List_[ANDROID]-Domestic_Payment
...
#    And Assert element by text from excel "<rowindex>" columnName "currentDomesticAccountBBAN"
  ...
  @Payments_Payments_Arhive_Resubmit_Payments_From_Past_Payment_List_[ANDROID]-Prenesi
  Scenario Outline: Payments_Payments_Arhive_Resubmit_Payments_From_Past_Payment_List_[ANDROID]-Prenesi
    ...
    And Remember text of first following sibling of element by text "Fee" in txt under key "keyFeeWithCurrency"
    And Click on element by contains text "Repeat"
    And Wait for element by contains text "Save recipient"
    ...
    And Enter text "TYUREDSF" in element id "nlb-input-creditor-address" and remember it under key "keyAddress"
